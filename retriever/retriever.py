...
class DocumentProcessor:
    ...
    """
    def __init__(self, headers_to_split_on: List[List[str]]):
        self.headers_to_split_on = headers_to_split_on

    def process(self, source: Any) -> List[Any]:
        """
...
class IndexBuilder:
    ...
    """
    def __init__(self, docs_list: List[Any], collection_name: str, persist_directory: str, load_documents: bool):
